...
class Hospital{
    ...
    public void agregarPaciente(Paciente paciente){
        ...
        try (Connection connection = DriverManager.getConnection(url, usuario, passwd)) {
            String query = "INSERT INTO pacientes (nombre, edad, historial_medico) VALUES (?, ?, ?)";
    ...
    public void eliminarPaceitne(String nombrePaciente){
        ...
        try {
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital_bd", "root", "");
